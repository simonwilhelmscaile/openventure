    ...
    <main className="min-h-screen bg-[var(--bg-primary)]">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-4 text-[var(--text-secondary)]">
          Have questions about OpenVenture? We&apos;d love to hear from you. Fill out the form below
        ...
        <div className="mt-12 rounded-lg border border-[var(--border-default)] p-6">
          ...
          <div className="mt-4 space-y-3 text-[var(--text-secondary)]">
            <p>
              <strong>Email:</strong> hello@openventure.app
            </p>
            <p>
              <strong>Support:</strong> support@openventure.app
            </p>
            <p>
              <strong>Twitter:</strong> @openventure
            </p>
          </div>
        </div>
      </div>
