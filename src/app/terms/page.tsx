...
export const metadata = {
  title: 'Terms of Service | OpenVenture',
  description: 'OpenVenture Terms of Service - Rules and guidelines for using our platform.',
};
...
export default function TermsPage() {
  return (
    <StaticPage title="Terms of Service">
      ...
      <p>
        Welcome to OpenVenture. By using our service, you agree to be bound by these Terms of Service.
        Please read them carefully.
      </p>

      <h2 className="mt-8 text-2xl font-bold text-[var(--text-primary)]">1. Acceptance of Terms</h2>
      <p>
        By accessing or using OpenVenture, you agree to these Terms and our Privacy Policy. If you don&apos;t
      ...
      <p>
        OpenVenture is an AI-powered platform that generates websites and blog content based on your business
      ...
      <p>
        Content generated using OpenVenture belongs to you. You grant us a license to use your configurations
      ...
      <p>
        OpenVenture is provided &quot;as is&quot; without warranties of any kind. We are not liable for any damages
      ...
      <p>
        Questions about these Terms? Contact us at legal@openventure.app.
      </p>
    </StaticPage>
  );
}
